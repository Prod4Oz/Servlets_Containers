...
//        controller = context.getBean(PostController.class); // получаем по классу бина
        controller = (PostController) context.getBean("postController");// получаем по имени бина
